...
import 'package:payroll/models/user_permission_model/update_permission_model.dart';
...
class AdminPermissionScreenController extends GetxController {
    ...
    try {
      ...
      if (isSuccessStatus.value) {
        ...
        await userPreference.setAllPermissionIntoPrefs(
          ...
          generalSettingView:
              userPermissionModel.data.generalsettingview == "on"
                  ? true
                  : false,
          generalSettingEdit:
              userPermissionModel.data.generalsettingedit == "on"
                  ? true
                  : false,
        );

        subAdminIsViewChecked.value =
            userPermissionModel.data.subadminview == "on" ? true : false;
        ...
        employeeDocumentIsViewChecked.value =
            userPermissionModel.data.employeedocumentview == "on"
                ? true
                : false;
        employeeDocumentIsAddChecked.value =
            userPermissionModel.data.employeedocumentadd == "on" ? true : false;
        employeeDocumentIsEditChecked.value = false;
        employeeDocumentIsDeleteChecked.value =
            userPermissionModel.data.employeedocumentdelete == "on"
                ? true
                : false;
        employeeDocumentIsDownloadChecked.value =
            userPermissionModel.data.employeedocumentdownload == "on"
                ? true
                : false;

        companyPayChecksIsViewChecked.value =
            userPermissionModel.data.payrollview == "on" ? true : false;
        companyPayChecksIsAddChecked.value =
            userPermissionModel.data.payrolladd == "on" ? true : false;
        companyPayChecksIsEditChecked.value = false;
        companyPayChecksIsDeleteChecked.value = true;
        companyPayChecksIsDownloadChecked.value =
            userPermissionModel.data.payrolldownload == "on" ? true : false;

        approvePayChecksIsViewChecked.value =
            userPermissionModel.data.approvepaychecksview == "on"
                ? true
                : false;
        ...
        approvePayChecksIsEditChecked.value =
            userPermissionModel.data.approvepaychecksedit == "on"
                ? true
                : false;
        approvePayChecksIsDeleteChecked.value =
            userPermissionModel.data.approvepaychecksdelete == "on"
                ? true
                : false;

        emailTemplateIsViewChecked.value =
            userPermissionModel.data.emailtemplateview == "on" ? true : false;
        emailTemplateIsAddChecked.value =
            userPermissionModel.data.emailtemplateadd == "on" ? true : false;
        emailTemplateIsEditChecked.value =
            userPermissionModel.data.emailtemplateedit == "on" ? true : false;

        roleIsViewChecked.value = true;
        roleIsEditChecked.value = true;

        generalSettingViewChecked.value =
            userPermissionModel.data.generalsettingview == "on" ? true : false;
        generalSettingEditChecked.value =
            userPermissionModel.data.generalsettingedit == "on" ? true : false;
      } else {
  ...
  Future<void> saveUserPermissionFunction() async {
    ...
    try {
      ...
      UpdatePermissionModel updatePermissionModel =
          UpdatePermissionModel.fromJson(json.decode(response.body));
  ...
  Map<String, dynamic> getData() {
    ...
    if (subAdminIsViewChecked.value == true) {
      data.addAll({"subadminview": "on"});
    }
    // if(subAdminIsAddChecked.value == true){}
    if (subAdminIsEditChecked.value == true) {
      data.addAll({"subadminedit": "on"});
    }
    // if(subAdminIsDeleteChecked.value == true){}
    if (companyInIsAddChecked.value == true) {
      data.addAll({"companyadd": "on"});
    }
    if (companyInIsEditChecked.value == true) {
      data.addAll({"companyedit": "on"});
    }
    if (departmentInIsViewChecked.value == true) {
      data.addAll({"departmentview": "on"});
    }
    if (departmentInIsAddChecked.value == true) {
      data.addAll({"departmentadd": "on"});
    }
    if (departmentInIsEditChecked.value == true) {
      data.addAll({"departmentedit": "on"});
    }
    if (departmentIsDeleteChecked.value == true) {
      data.addAll({"departmentdelete": "on"});
    }

    if (locationInIsViewChecked.value == true) {
      data.addAll({"locationview": "on"});
    }
    if (locationInIsAddChecked.value == true) {
      data.addAll({"locationadd": "on"});
    }
    if (locationInIsEditChecked.value == true) {
      data.addAll({"locationedit": "on"});
    }
    if (locationIsDeleteChecked.value == true) {
      data.addAll({"locationdelete": "on"});
    }

    if (employeeInIsViewChecked.value == true) {
      data.addAll({"employeeview": "on"});
    }
    if (employeeInIsAddChecked.value == true) {
      data.addAll({"employeeadd": "on"});
    }
    if (employeeInIsEditChecked.value == true) {
      data.addAll({"employeeedit": "on"});
    }
    if (employeeIsDeleteChecked.value == true) {
      data.addAll({"employeedelete": "on"});
    }

    if (employeeDocumentIsViewChecked.value == true) {
      data.addAll({"employeedocumentview": "on"});
    }
    if (employeeDocumentIsAddChecked.value == true) {
      data.addAll({"employeedocumentadd": "on"});
    }
    // if(employeeInIsEditChecked.value == true){}
    if (employeeDocumentIsDeleteChecked.value == true) {
      data.addAll({"employeedocumentdelete": "on"});
    }
    if (employeeDocumentIsDownloadChecked.value == true) {
      data.addAll({"employeedocumentdownload": "on"});
    }

    if (companyPayChecksIsViewChecked.value == true) {
      data.addAll({"payrollview": "on"});
    }
    if (companyPayChecksIsAddChecked.value == true) {
      data.addAll({"payrolladd": "on"});
    }
    if (companyPayChecksIsDownloadChecked.value == true) {
      data.addAll({"payrolldownload": "on"});
    }

    if (approvePayChecksIsViewChecked.value == true) {
      data.addAll({"approvepaychecksview": "on"});
    }
    if (approvePayChecksIsEditChecked.value == true) {
      data.addAll({"approvepaychecksedit": "on"});
    }
    if (approvePayChecksIsDeleteChecked.value == true) {
      data.addAll({"approvepaychecksdelete": "on"});
    }

    if (emailTemplateIsViewChecked.value == true) {
      data.addAll({"emailtemplateview": "on"});
    }
    if (emailTemplateIsAddChecked.value == true) {
      data.addAll({"emailtemplateadd": "on"});
    }
    if (emailTemplateIsEditChecked.value == true) {
      data.addAll({"emailtemplateedit": "on"});
    }

    if (generalSettingViewChecked.value == true) {
      data.addAll({"generalsettingview": "on"});
    }
    if (generalSettingEditChecked.value == true) {
      data.addAll({"generalsettingedit": "on"});
    }
