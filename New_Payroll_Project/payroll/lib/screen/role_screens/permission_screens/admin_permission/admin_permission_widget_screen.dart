...
import 'package:payroll/common_modules/permission_container_module.dart';
      ...
      child: Column(
        children: [
          ...
          PermissionBoxModule(
            ...
            isDeleteShow: true,
            isDeleteValue:
                adminPermissionScreenController.subAdminIsDeleteChecked.value,
          ...
          PermissionBoxModule(
            ...
            isViewShow: true,
            isViewValue:
                adminPermissionScreenController.locationInIsViewChecked.value,
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController.locationInIsViewChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            ...
            isEditShow: true,
            isEditValue:
                adminPermissionScreenController.locationInIsEditChecked.value,
            isEditOnChanged: (bool? value) {
              adminPermissionScreenController.locationInIsEditChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            ...
            isDeleteShow: true,
            isDeleteValue:
                adminPermissionScreenController.locationIsDeleteChecked.value,
            isDeleteOnChanged: (bool? value) {
              adminPermissionScreenController.locationIsDeleteChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
          ...
          PermissionBoxModule(
            ...
            isViewShow: true,
            isViewValue:
                adminPermissionScreenController.employeeInIsViewChecked.value,
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController.employeeInIsViewChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            ...
            isEditShow: true,
            isEditValue:
                adminPermissionScreenController.employeeInIsEditChecked.value,
            isEditOnChanged: (bool? value) {
              adminPermissionScreenController.employeeInIsEditChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            ...
            isDeleteShow: true,
            isDeleteValue:
                adminPermissionScreenController.employeeIsDeleteChecked.value,
            isDeleteOnChanged: (bool? value) {
              adminPermissionScreenController.employeeIsDeleteChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
          ...
          PermissionBoxModule(
            ...
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController
                  .employeeDocumentIsViewChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isAddShow: true,
            ...
            isAddOnChanged: (bool? value) {
              adminPermissionScreenController
                  .employeeDocumentIsAddChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isEditShow: true,
            ...
            isDeleteOnChanged: (bool? value) {
              adminPermissionScreenController
                  .employeeDocumentIsDeleteChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isDownloadShow: true,
            ...
            isDownloadOnChanged: (bool? value) {
              adminPermissionScreenController
                  .employeeDocumentIsDownloadChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
          ),
          const SizedBox(height: 15),
          ...
          PermissionBoxModule(
            ...
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController
                  .companyPayChecksIsViewChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isAddShow: true,
            isAddValue: adminPermissionScreenController
            ...
            isAddOnChanged: (bool? value) {
              adminPermissionScreenController
                  .companyPayChecksIsAddChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isEditShow: true,
            isEditValue: adminPermissionScreenController
                .companyPayChecksIsEditChecked.value,
            isEditOnChanged: (bool? value) {
            ...
            isDownloadOnChanged: (bool? value) {
              adminPermissionScreenController
                  .companyPayChecksIsDownloadChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
          ),
          const SizedBox(height: 15),
          ...
          PermissionBoxModule(
            ...
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController
                  .approvePayChecksIsViewChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isAddShow: true,
            isAddValue: adminPermissionScreenController
                .approvePayChecksIsAddChecked.value,
            isAddOnChanged: (bool? value) {
            ...
            isEditOnChanged: (bool? value) {
              ...
              if (value == false) {
                adminPermissionScreenController
                    .approvePayChecksIsDeleteChecked.value = false;
              }
              adminPermissionScreenController
                  .approvePayChecksIsEditChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isDeleteShow: true,
            isDeleteValue: adminPermissionScreenController
            ...
            isDeleteOnChanged: (bool? value) {
              adminPermissionScreenController
                  .approvePayChecksIsDeleteChecked.value = value!;
              adminPermissionScreenController.loadUI();
            },
            isDownloadShow: false,
          ),
          ...
          PermissionBoxModule(
            ...
            isViewOnChanged: (bool? value) {
              adminPermissionScreenController.emailTemplateIsViewChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            },
            isAddShow: true,
            isAddValue:
                adminPermissionScreenController.emailTemplateIsAddChecked.value,
            isAddOnChanged: (bool? value) {
              adminPermissionScreenController.emailTemplateIsAddChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            ...
            isEditOnChanged: (bool? value) {
              adminPermissionScreenController.emailTemplateIsEditChecked.value =
                  value!;
              adminPermissionScreenController.loadUI();
            },
            isDeleteShow: false,
          ...
          PermissionBoxModule(
            ...
            isViewShow: true,
            isViewValue:
                adminPermissionScreenController.roleIsViewChecked.value,
            isViewOnChanged: (bool? value) {
          ...
          CustomSubmitButtonModule(
            ...
            onPress: () async {
              await adminPermissionScreenController
                  .saveUserPermissionFunction();
            },
          ),
