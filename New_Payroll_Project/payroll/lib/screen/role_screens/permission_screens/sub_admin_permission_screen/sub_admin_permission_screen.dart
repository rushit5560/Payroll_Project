...
class SubAdminPermissionScreen extends StatelessWidget {
  ...
  final subAdminPermissionScreenController =
      Get.put(SubAdminPermissionScreenController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => subAdminPermissionScreenController.isLoading.value
            ? CommonLoader().showLoader()
            : SubadminPermissionWidgetScreen(),
      ),
    );
  }
}
