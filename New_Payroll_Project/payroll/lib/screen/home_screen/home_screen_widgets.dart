...
import 'package:payroll/models/company_list_screen_model/get_all_company_model.dart';
import 'package:payroll/screen/company_screens/company_manage_screen/company_manage_screen.dart';
import 'package:payroll/screen/company_screens/company_view_screen/company_view_screen.dart';
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      ...
                      log('companyViewPermission : $companyViewPermission');
