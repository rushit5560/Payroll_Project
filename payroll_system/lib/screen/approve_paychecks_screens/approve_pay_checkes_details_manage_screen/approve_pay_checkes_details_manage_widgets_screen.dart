            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  : SingleListTileModuleCustom(
                      textValue: "\$ ${approvalDataValue.hourlyRate}",
                      image: AppImages.salaryIcon,
                  ...
                  ? Container()
                  : SingleListTileModuleCustom(
                      textValue: "${approvalDataValue.ragularhour} Hours",
                      image: AppImages.salaryIcon,
                      textKey: AppMessage.regularHour),
                  approvalDataValue.payPeriod == "salary" ? Container() : const SizedBox(height: 5),

                  approvalDataValue.payPeriod == "salary"
                      ? Container()
                      : SingleListTileModuleCustom(
                      textValue: "${approvalDataValue.overtime} Hours",
                      image: AppImages.salaryIcon,
                  ...
                  approvalDataValue.payPeriod == "salary"
                      ? Container()
                      : SingleListTileModuleCustom(
                      textValue: "${approvalDataValue.holidaypay} Hours",
                      image: AppImages.salaryIcon,
              ...
              child: Column(
                children: [
                  ...
                  SingleListTileModuleCustom(
                      ...
                      image: AppImages.salaryIcon,
                      textKey: approvalDataValue.payPeriod == "salary" ? AppMessage.subTotal : AppMessage.hourlySubTotal),
                  const SizedBox(height: 5),
                  SingleListTileModuleCustom(
                    textValue: "\$ ${approvalDataValue.tax}",
                    image: AppImages.salaryIcon,
                  ...
                  const SizedBox(height: 5),
                  SingleListTileModuleCustom(
                      textValue: "\$ ${approvalDataValue.finalAmount.toString()}",
                      image: AppImages.netAmountIcon,
