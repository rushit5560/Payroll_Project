  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Form(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: DropdownButtonFormField<String>(
                      validator: (value) =>
                          FieldValidation().validateDropdownDateFormat(value!),
                      decoration: const InputDecoration.collapsed(hintText: ''),
                      value:
                          generalSettingsScreenController.selectedValue.value,
                      ...
                      onChanged: (String? value) {
                        ...
                        generalSettingsScreenController.isLoading(false);
                      },
                    ).commonOnlyPadding(
        ...
        ).commonOnlyPadding(right: 1.h, left: 1.h, top: 1.h, bottom: 1.h),
      ),
    );
  }
}
